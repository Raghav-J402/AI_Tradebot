...
class ML_Trader(Strategy):
    def initialize(self, symbol:str="SPY", cash_at_risk:float=.5):
        ...
        self.api = REST(key_id=API_KEY, secret_key=API_SECRET, base_url=BASE_URL, api_version='v2')
...
strategy = ML_Trader(name="strat",broker=broker,parameters={"symbol":"SPY","cash_at_risk":.5})
